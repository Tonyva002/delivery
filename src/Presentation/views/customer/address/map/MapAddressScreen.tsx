...
import useCustomerMapAddressViewModel from "./MapAddressViewModel";
...
export default function CustomerMapAddressScreen({ navigation, route }: Props) {
  const {
    mapRef,
    messagePermission,
    name,
  ...
  } = useCustomerMapAddressViewModel();
