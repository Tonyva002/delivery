...
import useDeliveryMapOrderViewModel from "./MapOrderViewModel";
...
export default function DeliveryMapOrderScreen({ navigation, route }: Props) {
  ...
  } = useDeliveryMapOrderViewModel(order);
