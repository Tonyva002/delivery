...
import useAdminCreateProductViewModel from "./CreateProductViewModel";
...
export default function AdminCreateProductScreen({ navigation, route }: Props) {
  ...
  const {
    ...
    createProduct,
    onChange,
  } = useAdminCreateProductViewModel(category);
