...
import useAdminUpdateProductViewModel from "./UpdateProductViewModel";
...
export default function AdminUpdateProductScreen({ navigation, route }: Props) {
  ...
  const {
    ...
    updateProduct,
    onChange,
  } = useAdminUpdateProductViewModel(product, category);
