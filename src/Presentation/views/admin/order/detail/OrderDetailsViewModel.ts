...
import { getDeliveryUseCase } from "../../../../../core/di/UserContainer";
...
export default function useAdminOrderDetailsViewModel(order: Order) {
  ...
  const getDelivery = async () => {
    const response = await getDeliveryUseCase.execute();
